...
<body>
    <div class="container">
		...
		<form method='post' action='addRoom.php' onsubmit='return true'>                       
                 <button type="submit" style= "width: 50%;  margin-left: auto; margin-right: auto; margin-bottom: 5px; border-radius: 5px;">Add Room</button>
         </form>
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        for(var i=0; i<len; i++)
                        {
                            ...
                            $("#roomDetailTable tr:last").after("<tr><td>"+patientID+"</td><td>"+name+"</td></tr>");
                        }
                    }
                });
            });
